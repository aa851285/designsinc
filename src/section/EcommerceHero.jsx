...
import { aiimg, circleaboutimage, circleVideo, ecommerceheri } from "../assets";
      ...
      <div className="flex flex-row justify-end items-center gap-x-28 pt-20 ">
        <div className="w-1/2">
          <motion.div variants={textVariant()}>
            ...
            <h2 className="text-white font-black md:text-[50px] sm:text-[30px] xs:text-[20px] text-[30px]">
              Your E-Commerce Website Doesn’t Have To Be Complicated.
            </h2>
          </motion.div>
...
export default sectionWrapper(EcommerceHero)